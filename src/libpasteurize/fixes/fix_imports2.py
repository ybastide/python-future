...
PY2MODULES = {
    ...
    + (u"FileDialog", u"LoadFileDialog", u"SaveFileDialog", u"dialogstates", u"test"),
    u"tkFileDialog": (
        u"Directory",
        u"Open",
        u"SaveAs",
    ...
    u"SimpleXMLRPCServer": (
        u"CGIXMLRPCRequestHandler",
        u"SimpleXMLRPCDispatcher",
        u"SimpleXMLRPCRequestHandler",
        u"SimpleXMLRPCServer",
        u"list_public_methods",
        u"remove_duplicates",
        u"resolve_dotted_attribute",
    ),
    u"DocXMLRPCServer": (
        u"DocCGIXMLRPCRequestHandler",
        u"DocXMLRPCRequestHandler",
        u"DocXMLRPCServer",
        u"ServerHTMLDoc",
        u"XMLRPCDocGenerator",
    ),
}

MAPPING = {
    u"urllib.request": (u"urllib2", u"urllib"),
...
def all_modules_subpattern():
    ...
    ret += (
        u" | ".join(
            [simple_name % (mod[0]) for mod in names_dot_attrs if mod[1] == u"__init__"]
        )
        + u" )"
    )
    return ret
